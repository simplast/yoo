...
> **Agent 工程实战** 系列第 6 篇 · 前置阅读：[第 5 篇 · 上下文管理](/posts/agent-arch-05-context-management)
...
*继续阅读：[第 7 篇：Agent 状态持久化与 Checkpointing](/posts/agent-arch-07-persistence) | 返回：[Agent 工程实战系列目录](/posts/agent-arch-overview)*
