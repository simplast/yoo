...
### 任务清单
- [ ] **冰霜塔 debuff 叠加**：减速效果支持持续叠加（当前为覆盖刷新）
- [ ] **腐蚀塔减甲叠加**：减甲效果支持层数叠加
- [ ] **光环系统扩展**：`systems/AuraSystem.ts` 目前只处理敌方光环，需新增友方光环加成可视化（攻速/攻击加成的视觉反馈）
- [ ] **新增控制塔**：眩晕塔（周期性眩晕）、冰冻塔（冻结定身）
  - 数据需在 `data/towers.ts` 新增塔定义
