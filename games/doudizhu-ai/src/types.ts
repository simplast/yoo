...
export type HandType =
  ...
  | "triple-single" | "triple-pair" | "straight" | "consecutive-pairs"
  | "airplane" | "airplane-singles" | "airplane-pairs"
  | "four-two" | "bomb" | "rocket";
...
export type ProviderId = "deepseek" | "spark-maas";
